...
public abstract class Frelon extends Animal {
	...
	protected boolean bonneProie = false;
	...
	protected void gestionProie(Animal a) {
		...
		for(Class<? extends Animal> typeDeClasse : proies) {
			if(typeDeClasse.isAssignableFrom(a.getClass())) {
				bonneProie = true;
				System.out.println(this.toString() + " mange " + a.toString());
			}
		}
